 ...
 */
class pdf_einstein_noborder extends ModelePDFCommandes
{
    /**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "einstein_noborder";
		$this->description = $langs->trans('PDFEinsteinNoBorderDescription');
